...
public class ExcelConverter {
     ...
     */
    public static ExcelConverter create(Workbook wb, Appendable output) {
        return new ExcelConverter(wb, output);
    }
     ...
     * @return An object for converting the workbook to HTML.
     */
    public static ExcelConverter create(String path, Appendable output)
            throws IOException {
     ...
     * @return An object for converting the workbook to HTML.
     */
    public static ExcelConverter create(InputStream in, Appendable output)
            throws IOException {
        try {
    ...
    private ExcelConverter(Workbook wb, Appendable output) {
        if (wb == null) {
    ...
    public static void main(String[] args) throws Exception {
        if(args.length < 2){
            System.err.println("usage: ExcelConverter inputWorkbook outputHtmlFile");
            return;
        }

        ExcelConverter toHtml = create(args[0], new PrintWriter(new FileWriter(args[1])));
    ...
    public void printPage() throws IOException {
        try {
            ...
            if (completeHTML) {
                out.format(
                        "<?xml version=\"1.0\" encoding=\""+encoding+"\" ?>%n");
                out.format("<html>%n");
                out.format("<head>%n");
                out.format("</head>%n");
                out.format("<body>%n");
